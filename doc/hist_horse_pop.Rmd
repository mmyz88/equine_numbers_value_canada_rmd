...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1."}
...
kable(max_horses, caption = "Table 1: Max and Min of horses for each Canadian province in 1940 - 1972")
```

Below we zoom in and look at the province of `r params$province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap='Figure 2.'}
